...
# Custom User Model
AUTH_USER_MODEL = 'dashboard_api.User'
...
# JWT Settings
JWT_SECRET_KEY = config('JWT_SECRET_KEY', default='dashboard-secret-key-change-in-production')
...
# ETL Configuration
AUTO_ETL_ENABLED = config('AUTO_ETL_ENABLED', default=True, cast=bool)
ETL_TIMEOUT_SECONDS = config('ETL_TIMEOUT_SECONDS', default=300, cast=int)
